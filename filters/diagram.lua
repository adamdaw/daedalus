...
-- Vendored from pandoc-ext/diagram v1.2.0
-- Source: https://github.com/pandoc-ext/diagram/tree/v1.2.0
-- Vendored for reproducibility — the filter is pinned to a specific tagged release.
-- To upgrade: download diagram.lua from the new release tag and replace this file.
